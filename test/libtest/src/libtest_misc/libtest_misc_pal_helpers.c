                                                                                  ...
                                                                                  lfds_pal_uint_t windows_processor_group_number )
{
  ...
  lp = libshared_memory_alloc_from_most_free_space_node( ms, sizeof(struct libtest_logical_processor), LFDS_PAL_ATOMIC_ISOLATION_IN_BYTES );
  ...
  LFDS_LIST_ASU_SET_VALUE_IN_ELEMENT( lp->lasue, lp );
  lfds_list_asu_insert_at_start( list_of_logical_processors, &lp->lasue );
