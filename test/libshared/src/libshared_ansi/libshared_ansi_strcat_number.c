...
/****************************************************************************/
void libshared_ansi_strcat_number( char *destination, lfds_pal_uint_t number )
{
  lfds_pal_uint_t
    digit,
    length = 0,
...
/****************************************************************************/
void libshared_ansi_strcat_number_with_leading_zeros( char *destination, lfds_pal_uint_t number, lfds_pal_uint_t minimum_width )
{
  lfds_pal_uint_t
    digit,
    length = 0,
